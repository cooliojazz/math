...
//        f.add(new FunctionDrawer<>(new FunctionDrawer.DrawingParameters<>(IntFixed.fromDouble(1.4), new NeoPoint2<>(IntFixed.fromDouble(-0.32467038152740657), IntFixed.fromDouble(-0.32267018065619124)), new NeoComplex<>(IntFixed.fromInt(2))), IntFixed.ZERO, BFMain::drawFractal));
        f.add(new FunctionDrawer<>(new FunctionDrawer.DrawingParameters<>(IntFixed.fromDouble(P2_2, 1.4), new NeoPoint2<>(IntFixed.fromHexString(P2_2, "-00000001.41e573611c9e57ee"), IntFixed.fromHexString(P2_2, "-00000000.68ccdcd44e3a9f56")), new NeoComplex<>(IntFixed.fromInt(P2_2, 2))), IntFixed.fromInt(P2_2, 2), BFMain::drawFractal));
//        f.add(new FunctionDrawer<>(new FunctionDrawer.DrawingParameters<>(ShortFixed.fromDouble(1.4), new NeoPoint2<>(ShortFixed.fromHexString("-0001.41e573611c9e57ee"), ShortFixed.fromHexString("-0000.68ccdcd44e3a9f56")), new NeoComplex<>(ShortFixed.fromInt(2))), ShortFixed.fromInt(2), BFMain::drawFractal));
