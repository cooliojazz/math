...
public class FunctionDrawer extends Canvas {
        
    private Class<T> type;Number

    private BFMain.Gradient grad = new BFMain.Gradient(new Color[] {Color.blue.darker(), Color.cyan.darker(), Color.yellow.darker().darker(), Color.red.darker(), Color.magenta.darker(), Color.blue.darker()});
    ...
    public FunctionDrawer(BFMain.FractalParameters params, Class<T> type) {
        this.type = type;
